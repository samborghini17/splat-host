...
for /d %%D in ("%BASE_DIR%\*") do (
    ...
    if not "!SCAN_NAME!"=="Voxel_Output" (
        ...
        if defined TARGET_PLY (
            ...
            :: DER FIX: Die Ausgabe-Datei direkt uebergeben, und --voxel-resolution 0.2 zum Schrumpfen (20cm)
            call splat-transform "!TARGET_PLY!" "%OUT_DIR%\!SCAN_NAME!.voxel.glb" --voxel-resolution 0.2
